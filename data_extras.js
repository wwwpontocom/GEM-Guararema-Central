Object.assign(BIBLIOTECA_LIVRO, {
    ...
    html_content: `
        <div style="font-family: sans-serif; line-height: 1.6; color: #333;">
            ...
            <h2 class="section-title"><span class="icon-box">🎻</span> INSTRUMENTOS - CORDAS</h2>
  ...
  <div style="display: flex; gap: 10px; margin: 15px 0; justify-content: center;">
            ...
            <h2 class="section-title"><span class="icon-box">🎶</span> INSTRUMENTOS - MADEIRAS</h2>
            <h3 style="color: var(--primary); border-bottom: 1px solid #ddd; padding-bottom: 5px;">1. Flauta</h3>
            <p>Conteúdo inicial para flautistas e fundamentos de embocadura.</p>
        </div>
    `,
    pagina: "Extra"
},
    ...
    pagina: "Extra"
        ...
        "exercicios": {
            ...
            html_content: `<p>Pratique o que aprendeu! A repetição é fundamental para a memorização da teoria musical.</p>`,
            pagina: "Extra"
        }
     });
