...
<button onclick="abrirPopup([
    ...
    '<b>DEEP LEARNING: EXEMPLOS</b><br><br>Clique no botão abaixo para ouvir o exemplo (Violoncelo):<br><br><div style=&quot;text-align:center; margin-top:20px;&quot;><img src=&quot;https://i.ibb.co/LhqZzS6/cello.png&quot; style=&quot;width:60px; display:block; margin:10px auto;&quot;><button onclick=&quot;new Audio(&apos;assets/audio/cello_exemplo1.mp3&apos;).play().catch(e => console.error(e))&quot; style=&quot;padding: 10px 20px; background: #28a745; color: white; border: none; border-radius: 5px; cursor: pointer; font-weight: bold;&quot;>Tocar Exemplo 🔊</button></div>'
