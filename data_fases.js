...
<button onclick="abrirPopup([
    ...
    '<b>DEEP LEARNING: EXEMPLOS</b><br><br>Clique no botão para ouvir o Violoncelo:<br><br><div style=&quot;text-align:center; margin-top:20px;&quot;><img src=&quot;https://i.ibb.co/LhqZzS6/cello.png&quot; style=&quot;width:50px; display:block; margin:10px auto;&quot;><div onclick=&quot;new Audio(&apos;assets/audio/cello_exemplo1.mp3&apos;).play().then(() => console.log(&apos;Audio playing!&apos;)).catch(e => alert(&apos;Audio Error&apos;))&quot; style=&quot;padding: 5px 10px; background: #28a745; color: white; border-radius: 4px; cursor: pointer; font-size: 11px; display: inline-block;&quot;>Ouvir Violoncelo 🔊</div></div>'
