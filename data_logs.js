Object.assign(BIBLIOTECA_LIVRO, {
    "grupo_a": {
        ...
        html_content: `
            <div id="log-grupo-a" class="log-container" style="max-height: 200px; overflow-y: auto; background: #f9f9f9; padding: 10px; border-radius: 5px; margin-bottom: 10px;">Carregando...</div>
    ...
    "grupo_b": {
        ...
        html_content: `
            <div id="log-grupo-b" class="log-container" style="max-height: 200px; overflow-y: auto; background: #f9f9f9; padding: 10px; border-radius: 5px; margin-bottom: 10px;">Carregando...</div>
    ...
    "grupo_c": {
        ...
        html_content: `
            <div id="log-grupo-c" class="log-container" style="max-height: 200px; overflow-y: auto; background: #f9f9f9; padding: 10px; border-radius: 5px; margin-bottom: 10px;">Carregando...</div>
...
// --- FIX IS HERE: Definimos o mestre APÓS os grupos existirem ---
Object.assign(BIBLIOTECA_LIVRO, {
    "historico_teoria": {
        ...
        html_content: `
            <div class="theory-control-container">
                ...
                <div style="display: flex; flex-direction: column; gap: 30px; margin-top: 20px;">
                    <section><h3 style="color:#4a90e2; border-bottom:1px solid #ddd;">GRUPO A</h3>${BIBLIOTECA_LIVRO["grupo_a"].html_content}</section>
                    <section><h3 style="color:#4a90e2; border-bottom:1px solid #ddd;">GRUPO B</h3>${BIBLIOTECA_LIVRO["grupo_b"].html_content}</section>
                    <section><h3 style="color:#4a90e2; border-bottom:1px solid #ddd;">GRUPO C</h3>${BIBLIOTECA_LIVRO["grupo_c"].html_content}</section>
                </div>
            </div>
            <script>if (typeof carregarLogs === "function") carregarLogs();</script>
        `
