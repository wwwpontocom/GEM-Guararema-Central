...
// Persistent Independent Scale Logic (Using CSS Variables to prevent freezing)
...
function updateZoom(target, delta) {
    ...
    if (target === 'app') {
        ...
        // Apply scaling via CSS variable on the root - very stable for sidebars
        document.documentElement.style.setProperty('--app-scale', appZoomLevel);
