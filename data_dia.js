Object.assign(BIBLIOTECA_LIVRO, {
    ...
    <div style="margin-bottom: 20px;">
        ...
        <div style="display: flex; flex-wrap: wrap; gap: 5px;">
            <button onclick="filtrarListaRapida('todos')" style="padding: 5px 10px; font-size: 12px; cursor: pointer;">Todos</button>
            <button onclick="filtrarListaRapida('teoria1')" style="padding: 5px 10px; font-size: 12px; cursor: pointer;">T1</button>
            <button onclick="filtrarListaRapida('teoria2')" style="padding: 5px 10px; font-size: 12px; cursor: pointer;">T2</button>
            <button onclick="filtrarListaRapida('teoria3')" style="padding: 5px 10px; font-size: 12px; cursor: pointer;">T3</button>
            <button onclick="filtrarListaRapida('manha')" style="padding: 5px 10px; font-size: 12px; cursor: pointer;">Manhã</button>
            <button onclick="filtrarListaRapida('cordas')" style="padding: 5px 10px; font-size: 12px; cursor: pointer;">🎻 Cordas</button>
            <button onclick="filtrarListaRapida('madeiras')" style="padding: 5px 10px; font-size: 12px; cursor: pointer;">🎷 Madeiras</button>
            <button onclick="filtrarListaRapida('metais')" style="padding: 5px 10px; font-size: 12px; cursor: pointer;">🎺 Metais</button>
        </div>
    </div>

    <div id="lista-dinamica-alunos" style="background: white; border: 1px solid #eee; padding: 10px; border-radius: 5px; max-height: 300px; overflow-y: auto;">
        </div>
